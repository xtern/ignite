...
@Fork(value = 1, jvmArgsAppend = {"-Xms1g", "-server", "-XX:+AggressiveOpts", "-XX:MaxMetaspaceSize=256m", "-ea", "-Djmh.executor=CUSTOM", "-Djmh.executor.class=org.apache.ignite.thread.FastThreadExecutor"})
    ...
    public static class FreeListProvider {
        ...
        private FreeList<CacheDataRow> createFreeList(
            ...
            return new CacheFreeList(
                ...
                metaPageId,
                true,
                new PageLockTrackerManager(log, "1").createPageLockTracker("freelist")
            );
        }
    }
