...
@Fork(value = 0, jvmArgsAppend = {"-Xms3g", "-Xmx3g", "-server", "-XX:+AggressiveOpts", "-XX:MaxMetaspaceSize=256m", "-ea"})
@OutputTimeUnit(TimeUnit.MICROSECONDS)
@State(Scope.Benchmark)
@Threads(1)
@Warmup(iterations = 10, time = 300, timeUnit = MILLISECONDS)
@Measurement(iterations = 8, time = 300, timeUnit = MILLISECONDS)
...
//        r100_32000(100, 32_000);
     ...
     */
    @Benchmark
    public void checkPreloading(Data data, Preloader preloader) {
