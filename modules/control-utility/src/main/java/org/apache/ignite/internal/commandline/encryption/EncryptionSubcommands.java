...
public enum EncryptionSubcommands {
    ...
    /** Subcommand to get current encryption key IDs for specified cache group. */
    ...
    /** Subcommand to get re-encryption status of cache group. */
    CACHE_GROUP_ENCRYPTION_STATUS("cache_group_encryption_status", new EncryptionStatusCommand()),
    ...
    /** */
    REENCRYPTION_RATE("change_reencryption_rate", new ChangeReencryptionRateCommand());
