...
import org.apache.ignite.internal.processors.cache.persistence.snapshot.SnapshotRestoreOperationDetails;
...
public class VisorSnapshotRestoreTask extends VisorOneNodeTask<VisorSnapshotRestoreTaskArg, String> {
    ...
    private static class VisorSnapshotRestoreStatusJob extends VisorJob<VisorSnapshotRestoreTaskArg, String> {
        ...
        /** {@inheritDoc} */
        @Override protected String run(VisorSnapshotRestoreTaskArg arg) throws IgniteException {
            Map<UUID, SnapshotRestoreOperationDetails> nodesStatus =
                ignite.context().cache().context().snapshotMgr().restoreStatus(arg.snapshotName()).get();
            ...
            for (Map.Entry<UUID, SnapshotRestoreOperationDetails> e : nodesStatus.entrySet()) {
                SnapshotRestoreOperationDetails details = e.getValue();
