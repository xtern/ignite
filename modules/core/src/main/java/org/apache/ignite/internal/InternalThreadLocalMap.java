...
//    private static final InternalLogger logger = InternalLoggerFactory.getInstance(InternalThreadLocalMap.class);
    ...
    public static InternalThreadLocalMap getIfSet() {
        ...
        if (thread instanceof IgniteThread) {
            return ((IgniteThread) thread).threadLocalMap();
        }
...
//            assert false;
            ...
            return fastGet((IgniteThread) thread);
        } else {
            assert false;
    ...
    private static InternalThreadLocalMap fastGet(IgniteThread thread) {
    ...
    public static void remove() {
        Thread thread = Thread.currentThread();
        if (thread instanceof IgniteThread) {
            ((IgniteThread) thread).setThreadLocalMap(null);
        } else {
