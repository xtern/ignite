...
public interface IgniteCacheOffheapManager {
     ...
     * @throws IgniteCheckedException If failed.
     */
    public void invokeAll(GridCacheContext cctx, Collection<KeyCacheObject> keys, GridDhtLocalPartition part,
        OffheapInvokeAllClosure c) throws IgniteCheckedException;
